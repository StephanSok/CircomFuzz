...
NULL,
NULL };
uint get_main_input_signal_start() {return 71;}

uint get_main_input_signal_no() {return 1;}

uint get_total_signal_no() {return 143;}
...
void release_memory_component(Circom_CalcWit* ctx, uint pos) {
    ...
    // std::cout << "delete delelet delet delet " << pos << std::endl;
    // if (ctx == nullptr || ctx->componentMemory == nullptr) return;
    // if (ctx->componentMemory[pos].subcomponents != nullptr) {
    delete[] ctx->componentMemory[pos].subcomponents;
    // }
    // std::cout << "delete delelet delet delet " << pos << std::endl;
    // std::cout << "-----------------" << ctx->componentMemory[pos].subcomponentsParallel << std::endl;
    // if (ctx->componentMemory[pos].subcomponentsParallel != nullptr) {
    //     std::cout << "-----------------" << ctx->componentMemory[pos].subcomponentsParallel << std::endl;
    //     delete ctx->componentMemory[pos].subcomponentsParallel;
    // }
    // if (ctx->componentMemory[pos].outputIsSet != nullptr) {
    //     delete ctx->componentMemory[pos].outputIsSet;
    // }
    // if (ctx->componentMemory[pos].mutexes != nullptr) {
    //     delete ctx->componentMemory[pos].mutexes;
    // }
    // if (ctx->componentMemory[pos].cvs != nullptr) {
    //     delete ctx->componentMemory[pos].cvs;
    // }
    // if (ctx->componentMemory[pos].sbct != nullptr){
...
// std::cout << " new new new new new 0" << coffset << std::endl;
}
...
// load src
Fr_shr(&expaux[1],&signalValues[mySignalStart + 70],&lvar[3]); // line circom 32
...
Fr_eq(&expaux[0],&lvar[1],&signalValues[mySignalStart + 70]); // line circom 38
...
// std::cout << " new new new new new 1" << coffset << std::endl;
}
